...
```
wget -q -O blockpi-monitoring-installer.sh https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-klaytn-monitoring/main/blockpi-monitoring-installer.sh && chmod +x blockpi-monitoring-installer.sh && sudo /bin/bash blockpi-monitoring-installer.sh
```
