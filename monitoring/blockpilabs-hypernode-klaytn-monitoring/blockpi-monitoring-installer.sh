...
function installPrometheus {
	...
	cd /opt/prometheus
	echo -e '\n\e[42mDownloading packages...\e[0m\n'
  wget -O prometheus.yml https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-klaytn-monitoring/main/prometheus/prometheus.yml
