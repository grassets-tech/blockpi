...
function installNodeExporter {
  ...
  wget -O /etc/systemd/system/node_exporter.service  https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-polygon-monitoring/main/node_exporter.service
...
function installPrometheus {
  ...
  wget -O /etc/systemd/system/prometheus.service https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-polygon-monitoring/main/prometheus.service
...
function installGrafana {
  ...
  wget -O /etc/grafana/provisioning/datasources/prometheus.yml https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/datasources/prometheus.yml
  wget -O /etc/grafana/provisioning/dashboards/dashboards.yml https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/dashboards/dashboards.yml
	wget -O /etc/grafana/provisioning/dashboards/HyperNode.json https://raw.githubusercontent.com/grassets-tech/blockpi/monitoring/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/dashboards/HyperNode.json
